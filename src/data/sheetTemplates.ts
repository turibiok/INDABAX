...
const PROFILES_TEMPLATE: SheetTemplate = {
  ...
  aliases: {
    ...
    'Site web': ['Site', 'Website', 'Web', 'Page web', 'Portfolio', 'URL'],
  ...
  notes: [
    ...
    'Chacun renseigne lui-même son téléphone (le WhatsApp, le plus souvent), son site et sa présentation, depuis « Mon Profil ». Ces colonnes sont donc écrites par l’application autant que par vous.',
